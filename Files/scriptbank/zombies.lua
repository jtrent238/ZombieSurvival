--[[
anim0         = 225,275 ; jump,
anim1         = 0,100 eat, look, idle
anim2         = 100,160 ; standup, warning
anim3         = 165,220 ; attack
anim4         = 276,325 ; die
--]]
...
local w2a_delay_init = 500
--how long before dead body gets removed
local remove_delay_init = 5000
--damage per attack
local damage = 80
...
StopSound(e,1)
 ...
 if GetAnimationFrame(e) < 339 or GetAnimationFrame(e) > 412 then
 StopAnimation(e)
 AIEntityStop(EntObjNo)
 end
...
--******************************************************************
 ...
 g_Entity[e]['animating'] = 1 
  ...
  if GetAnimationFrame(e) > 411 and GetAnimationFrame(e) <= 724 and hit[e] == 0 then
  hit[e] = 1
 FireWeapon(e)
 HurtPlayer(e,damage)
 attacking[e] = 0
 ...
 if GetAnimationFrame(e) < 415 or GetAnimationFrame(e) > 511 then
  StopAnimation(e)
 PlaySound(e,3)
  end
 ...
 if GetAnimationFrame(e) >= 511 and GetTimer(e) >= remove_delay[e] then
 StopSound(e,3)
Destroy(e)
 end
 end
...
function zombies_exit(e)
    PlayCharacterSound(e,"onDeath")
        Killed = Killed + 1
		TextCenterOnX(50,1,3,"You have Killed: "..Killed.." Zombies!")
        --critter = critter - 1
end