...
function ai_zombie_waypoint_run_init_name(e,name)
weapon_name[e] = name
end

function ai_zombie_waypoint_run_main(e)

if ai_starting_health[e] == nil then
ai_starting_health[e] = g_Entity[e]['health']
ai_soldier_pathindex[e] = -1
ai_soldier_state[e] = "idle"
lastroar[e]= GetTimer(e)+math.random(6000,32000)
hit[e] = 0
damageframe[e] = 2800
else
...
if ai_soldier_pathindex[e] == -1 then
  ...
  if ai_soldier_pathindex[e] > -1 then 
   ...
   if g_Entity[e]['x'] > ai_patrol_x[e] - 80 and g_Entity[e]['x'] < ai_patrol_x[e] + 80 and g_Entity[e]['z'] > ai_patrol_z[e] - 80 and g_Entity[e]['z'] < ai_patrol_z[e] + 80 then
...
SetAnimationFrames(2775,2820)
damageframe[e] = 2800
else
SetAnimationFrames(2916,2969)
damageframe[e] = 2940
end
PlayAnimation(e)
...
function ai_zombie_waypoint_run_exit(e)
