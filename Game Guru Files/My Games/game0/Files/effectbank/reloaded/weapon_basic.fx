string Description = "Weapon Shader (non-bones)";
...
vertexOutput mainVS_highest(appdata IN)
{
	...
	// no bone modifiers
    float3 netPosition = IN.Position.xyz;
	float3 netNormal = IN.Normal.xyz;
    ...
    LightSource.xyz = LightSource.xyz;// + float3(1,10,1); 
